...
HRESULT SrvrCtrl::Init(LPCLASSDESCRIPTOR pClass)
{
    _pClass = pClass;
    return NOERROR;
}
...
HRESULT SrvrCtrl::TransitionTo(OLE_SERVER_STATE state)
{
#if DBG
    TCHAR achTemp[256];
...
HRESULT SrvrCtrl::PassiveToLoaded(void)
{
    return NOERROR;
}
...
HRESULT SrvrCtrl::LoadedToRunning(void)
{
...
HRESULT SrvrCtrl::LoadedToPassive(void)
{
...
HRESULT SrvrCtrl::RunningToLoaded(void)
{
...
HRESULT SrvrCtrl::RunningToOpened(void)
{
...
HRESULT SrvrCtrl::OpenedToRunning(void)
{
...
HRESULT SrvrCtrl::RunningToInPlace(void)
{
    if (_pInPlace == NULL)
    {
...
HRESULT SrvrCtrl::InPlaceToRunning(void)
{
...
HRESULT SrvrCtrl::InPlaceToUIActive(void)
{
    Assert(_pInPlace != NULL);
...
HRESULT SrvrCtrl::UIActiveToInPlace(void)
{
    Assert(_pInPlace != NULL);
...
HRESULT SrvrCtrl::DoShow(LPVOID pv, LONG iVerb, LPMSG lpmsg, LPOLECLIENTSITE pActiveSite, LONG lindex, HWND hwndParent, LPCRECT lprcPosRect)
{
...
HRESULT SrvrCtrl::DoOpen(LPVOID pv, LONG iVerb, LPMSG lpmsg, LPOLECLIENTSITE pActiveSite, LONG lindex, HWND hwndParent, LPCRECT lprcPosRect)
{
...
HRESULT SrvrCtrl::DoHide(LPVOID pv,
        LONG iVerb,
        LPMSG lpmsg,
...
HRESULT SrvrCtrl::DoUIActivate(LPVOID pv,
        LONG iVerb,
        LPMSG lpmsg,
        LPOLECLIENTSITE pActiveSite,
        LONG lindex,
...
HRESULT SrvrCtrl::DoInPlaceActivate(LPVOID pv,
        LONG iVerb,
        LPMSG lpmsg,
        LPOLECLIENTSITE pActiveSite,
        LONG lindex,
...
STDMETHODIMP SrvrCtrl::SetClientSite(LPOLECLIENTSITE pClientSite)
{
    //
...
STDMETHODIMP SrvrCtrl::GetClientSite(LPOLECLIENTSITE FAR* ppClientSite)
{
...
STDMETHODIMP SrvrCtrl::SetHostNames(LPCOLESTR lpstrCntrApp, LPCOLESTR lpstrCntrObj)
{
...
STDMETHODIMP SrvrCtrl::Close(DWORD dwSaveOption)
{
    HRESULT hr = NOERROR;
        ...
        case OLECLOSE_PROMPTSAVE:
            {
                ...
                // the container
                LPOLESTR lpstrObj = _pDV -> GetMonikerDisplayName(OLEGETMONIKER_ONLYIFTHERE);
                if (lpstrObj == NULL)
                {
...
STDMETHODIMP SrvrCtrl::SetMoniker(DWORD dwWhichMoniker, LPMONIKER pmk)
{
...
STDMETHODIMP SrvrCtrl::GetMoniker(DWORD dwAssign, DWORD dwWhichMoniker, LPMONIKER FAR* ppmk)
{
    if (ppmk == NULL)
    {
...
STDMETHODIMP SrvrCtrl::InitFromData(LPDATAOBJECT pDataObject,
        BOOL fCreation,
        DWORD dwReserved)
{
    return S_FALSE;
...
STDMETHODIMP SrvrCtrl::GetClipboardData(DWORD dwReserved, LPDATAOBJECT FAR* ppDataObject)
{
...
STDMETHODIMP SrvrCtrl::DoVerb(LONG iVerb,
        LPMSG lpmsg,
        LPOLECLIENTSITE pActiveSite,
        LONG lindex,
        HWND hwndParent,
...
STDMETHODIMP SrvrCtrl::EnumVerbs(LPENUMOLEVERB FAR* ppenum)
{
    if (ppenum == NULL)
    {
...
STDMETHODIMP SrvrCtrl::Update(void)
{
    return NOERROR;
}
...
STDMETHODIMP SrvrCtrl::IsUpToDate(void)
{
    return NOERROR;
}
...
STDMETHODIMP SrvrCtrl::GetUserClassID(CLSID FAR* pClsid)
{
    if (pClsid == NULL)
    {
...
STDMETHODIMP SrvrCtrl::GetUserType(DWORD dwFormOfType, LPOLESTR FAR* plpstr)
{
...
STDMETHODIMP SrvrCtrl::SetExtent(DWORD dwDrawAspect, LPSIZEL lpsizel)
{
    if (lpsizel == NULL)
    {
...
STDMETHODIMP SrvrCtrl::GetExtent(DWORD dwDrawAspect, LPSIZEL lpsizel)
{
    if (lpsizel == NULL)
    {
...
STDMETHODIMP SrvrCtrl::Advise(IAdviseSink FAR* pAdvSink, DWORD FAR* pdwConnection)
{
...
STDMETHODIMP SrvrCtrl::Unadvise(DWORD dwConnection)
{
    if (_pOleAdviseHolder == NULL)
        return NOERROR;
...
STDMETHODIMP SrvrCtrl::EnumAdvise(LPENUMSTATDATA FAR* ppenumAdvise)
{
...
STDMETHODIMP SrvrCtrl::GetMiscStatus(DWORD dwAspect, DWORD FAR* pdwStatus)
{
    if (pdwStatus == NULL)
    {
...
STDMETHODIMP SrvrCtrl::SetColorScheme(LPLOGPALETTE lpLogpal)
{
